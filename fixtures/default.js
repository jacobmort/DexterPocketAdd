    ...
    , data: {
        local_test_step: {
            ...
            input: {
                ...
                urls: [{url: "http://www.nytimes.com/pages/dining/index.html?action=click&pgtype=Homepage&region=TopBar&module=HPMiniNav&contentCollection=Food&WT.nav=page"},{url: "http://www.infoq.com/presentations/Evolution-of-Code-Design-at-Facebook"}]
            }
        }
    }
}, env);
